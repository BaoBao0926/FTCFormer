cfg = dict(
    data_path='/dke/zcy/EMNIST_byclass', data_set='EMNIST_byclass', epochs=150,
    input_size=64,
    ...
    # FDPC_KNN=True,  if_WSN=True,  Cmerge=True,  # output_dir='work_dirs/EMNIST_byclass/light/Fuzzy_tcformer_WSN_Cmerge/1',   # here 
