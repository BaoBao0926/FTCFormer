...
"""
CUDA_VISIBLE_DEVICES=0 python main.py --config configs/BloodCell/light_Ftcformer.py
CUDA_VISIBLE_DEVICES=1 python main.py --config configs/BloodCell/light_Ftcformer.py
"""